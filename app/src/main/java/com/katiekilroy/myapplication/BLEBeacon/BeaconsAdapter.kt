    ...
    class BeaconHolder(inflater: LayoutInflater, parent: ViewGroup) :
        ...
        fun bind(beacon: Beacon) {
            ...
            if (beacon.type == Beacon.beaconType.iBeacon) {
                ...
                distance?.text = String.format(context.getString(R.string.distance), beacon.distance)
                image?.setImageDrawable(ContextCompat.getDrawable(context, R.drawable.beacon_icon))
